    ...
    return (
        <div className="carousel_container">
            <div className="carrousel">
                {displayElement && <img src={arrowPrevious} onClick={() => onChangePicture(true)} className="arrow_previous" />}
                <img src={pictures[currentPictureIndex]} className="carrousel_picture" />
                {displayElement && <img src={arrowNext} onClick={() => onChangePicture(false)} className="arrow_next" />}
            </div>
        </div>
    )
}
